...
class TestLogParser < MiniTest::Unit::TestCase
  ...
  def test_stripped_log
    vals = @neo.parse_logfmt "xid=0x2341 measure.thing=val derpherp=asdlkfj"
  ...
  def test_real_log
    ...
    assert_equal vals[:timestamp] , Time.parse("2012-12-10T03:00:48.123456Z")
